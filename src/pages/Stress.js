...
function Stress() {
    ...
    return (
        <div className='Intro'>
            <div className='Introtitle'><h3>스트레스 관리</h3></div>
            ...
            <div className='question'>
                질문1.스트레스를 받을 때 주로 어떤 생각이 드나요?<br/>
                그런 생각들이 당신의 행동이나 일상에 어떤 영향을 끼치나요? 
                    <textarea
                        id='question1'
                        value={question1}
                ...
                질문2.스트레스를 받을 때 몸이나 마음에 나타나는 변화는 무엇인가요?<br/>
                예를 들어 두통,피로,불안감 등 정서적,신체적 변화가 있나요? &nbsp;
                    <textarea
                        id='question2'
                        value={question2}
