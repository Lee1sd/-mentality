...
function Problem() {
    ...
    return (
        <div className='Intro'>
            <div className='Introtitle'><h3>문제 해결 &nbsp; &nbsp; &nbsp;</h3></div>
            ...
            <div className='question'>
                질문1.현재 당신이 직면하고 있는 가장 큰 문제는 무엇인가요?<br/>
                문제를 해결하기 위해 시도해 본 방법들은 어떤 것들이었나요?
                    <textarea
                        id='question1'
                        value={question1}
                ...
                질문2.문제를 해결하는 데 있어서 가장 큰 장애물은 무엇인가요?<br/>
                그 장애물을 해결하는 데 어떤 외부의 도움이 필요하신가요? &nbsp;&nbsp;
                    <textarea
                        id='question2'
                        value={question2}
