...
function Relationships() {
    ...
    return (
        <div className='Intro'>
            <div className='Introtitle'><h3>대인관계 개선</h3></div>
            ...
            <div className='question'>
                질문1.어떤 유형의 사람과 관계를 맺는 것이 어려운가요?<br/>
                그리고 그런 상황에서 보이는 주된 행동 패턴은 무엇인가요? &nbsp;&nbsp;
                    <textarea
                        id='question1'
                        value={question1}
                ...
                질문2.대인관계에서 자신의 의사를 명확히 전달하기 어려운가요?<br/>
                문제를 해결하기 위해 어떤 접근 방법을 생각하고 계신가요?&nbsp; &nbsp;
                    <textarea
                        id='question2'
                        value={question2}
