...
function Relationships() {
    ...
    return (
        <div className='Intro'>
            <div className='Introtitle'><h3>삶의 질 향상&nbsp;</h3></div>
            ...
            <div className='question'>
                질문1.현재 삶에서 가장 만족스럽지 못한 부분은 무엇인가요?&nbsp;<br/>
                그 부분이 당신의 전반적인 행복에 어떤 영향을 미치나요? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <textarea
                        id='question1'
                        value={question1}
                ...
                질문2.미래에 어떤 삶을 살고 싶으신가요?&nbsp;&nbsp;&nbsp;<br/>
                미래의 목표를 위해 현재 생활에서 어떤 점을 바꿔야 할까요? &nbsp;
                    <textarea
                        id='question2'
                        value={question2}
