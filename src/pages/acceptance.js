...
function Acceptance() {
    ...
    return (
        <div className='Intro'>
            <div className='Introtitle'><h3>자기 수용 &nbsp; &nbsp; &nbsp;</h3></div>
            ...
            <div className='question'>
                질문1.자신의 약점이나 부족한 부분을 어떻게 인식하고 계신가요?<br/>
                그 부분을 받아들이는 데 있어 가장 어려운 점은 무엇인가요?&nbsp;&nbsp;
                    <textarea
                        id='question1'
                        value={question1}
                ...
                질문2.자신에 대해 긍정적으로 평가하는 부분은 무엇인가요?<br/>
                그 부분이 당신의 삶에 어떤 영향을 준다고 생각하시나요?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <textarea
                        id='question2'
                        value={question2}
